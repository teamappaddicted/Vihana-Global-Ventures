      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          <section>
            ...
            <p>
              Vihana Global Ventures ("we", "us", "our", or "Company") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Cookies:</strong> We use cookies and similar technologies to track and improve your experience</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. Use of Your Information</h2>
            <p>We use the information we collect or receive for purposes including:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Responding to your inquiries and providing customer support</li>
              <li>Sending marketing communications about our services</li>
              <li>Improving our website and services</li>
              <li>Protecting against fraudulent or unlawful use</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>With business partners for joint ventures</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Data portability in applicable jurisdictions</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Our website uses cookies to enhance your experience. You can control cookie settings through your browser. Please note that disabling cookies may affect website functionality.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Our website is not directed to individuals under 18 years of age. We do not knowingly collect personal information from children.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on our website and updating the effective date.
            </p>
          </section>
